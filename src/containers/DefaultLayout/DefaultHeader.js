      ...
      <React.Fragment>
        ...
        <Nav className="d-md-down-none" navbar>
          <NavItem className="px-3">
            <NavLink to="/dashboard" className="nav-link" >Nhóm 1</NavLink>
          </NavItem>
          <NavItem className="px-3">
            <Link to="/account/users" className="nav-link">Nhóm 2</Link>
          </NavItem>
          <NavItem className="px-3">
            <NavLink to="#" className="nav-link">Nhóm 6</NavLink>
          </NavItem>
        </Nav>
