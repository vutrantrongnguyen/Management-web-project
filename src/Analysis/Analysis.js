    ...
    return (
      <Card>
        ...
        <CardBody>
         <Row>
           <Col md={6}>
             <img src={constant.image} style={{height:'100px'}} alt=""/>
           </Col>
           <Col md={6}>
             <Button color="primary" style={{float:'right'}} onClick={() => this.props.history.push('/analysis/detail/')} >Tạo báo cáo</Button>
             <Button color="danger" style={{float:'right'}}>Xóa</Button>
           </Col>
         </Row>
        </CardBody>
      </Card>
